                ...
                return new ResponseEntity<>(
                        new BookAppointmentResponseDto(
                                ...
                                new AppointmentDataDto(
                                        newAppointment.getDateStart(),
                                        newAppointment.getDateEnd(),
                                        newAppointment.getReason())
                        ),
                        HttpStatus.OK
                );
            } catch (ParseException e) {
                return new ResponseEntity<>(new BookAppointmentResponseDto(-1,
                        BookAppointmentResponseDto.BookingStatus.ERROR),
                        HttpStatus.BAD_REQUEST);
            }
